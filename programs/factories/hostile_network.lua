...
local function init()
    ...
    create_full_path(peripheral_names.sheep, peripheral_names.chest_predict_overworld, peripheral_names.fabricator_wool, peripheral_names.chest_wool, item_names.predict_overworld)
